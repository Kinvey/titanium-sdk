...
```bash
npm install kinvey-titanium-sdk@3.0.0-beta.17 --save
```

or

```bash
bower install kinvey-titanium-sdk#3.0.0-beta.17 --save
```
...
```html
<script src="bower_components/kinvey-titanium-sdk/dist/kinvey-titanium-sdk.min.js"></script>
```
